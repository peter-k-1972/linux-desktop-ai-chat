...
| **App-Root-Module (Übergang)** | `app/db.py`, `app/critic.py` | In `TEMPORARILY_ALLOWED_ROOT_FILES` dokumentiert; Re-Export/Brücken zu echten Paketen |
