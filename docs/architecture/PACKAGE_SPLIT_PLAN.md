...
| `workflows`, `projects`, `persistence` | `workflows`: `linux-desktop-chat-workflows/src/app/workflows/` → `app.workflows`; `projects`: `linux-desktop-chat-projects/src/app/projects/` → `app.projects`; `app/persistence/` | `ldc-workspace-data` | `core`, `utils` | Persistenz-/Workflow-Tests | Migration/ORM an Host-Editionen; **projects** — [`PACKAGE_PROJECTS_PHYSICAL_SPLIT.md`](PACKAGE_PROJECTS_PHYSICAL_SPLIT.md); **workflows** — [`PACKAGE_WORKFLOWS_PHYSICAL_SPLIT.md`](PACKAGE_WORKFLOWS_PHYSICAL_SPLIT.md) |
