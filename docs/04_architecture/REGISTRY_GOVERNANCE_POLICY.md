...
| Screen Registry | `app/gui/bootstrap.py` | register_all_screens() |
| Model Registry | `app/core/models/registry.py` | _load_defaults(), register() |
| Command Registry (Core) | `app/gui/commands/palette_loader.py` | load_all_palette_commands(), load_feature_commands() |
| Command Registry (GUI) | `app/gui/commands/bootstrap.py` | register_commands() |
| Agent Registry | `app/agents/agent_registry.py` | register_profile() (nach CRUD), seed_agents |
...
- **Agent-Registry:** Agent CRUD-Flow, seed_agents
...
- **Screen Registry:** Einmal bei Bootstrap; register_all_screens() vor WorkspaceHost
