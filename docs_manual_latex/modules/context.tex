...
\textbf{Entwickler} & Aufl\textbackslash\{\}"osung, Traces, Replay/Repro-CLI unter \texttt{linux-desktop-chat-cli/src/app/cli/} (\texttt{app.cli}), Tests unter \texttt{tests/}. \\
...
\begin{itemize}
\item \texttt{linux-desktop-chat-cli/src/app/cli/context\_replay.py}, \texttt{context\_repro\_run.py}, \texttt{context\_repro\_batch.py}, Registry-CLI --- deterministische Kontext-Replays ohne GUI (\texttt{app.cli}).
\end{itemize}
