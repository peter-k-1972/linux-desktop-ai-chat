"""
BaseManagementWorkspace – Basis für Control-Center-Workspaces.

Models, Providers, Agents, Tools, Data Stores.
...
class BaseManagementWorkspace(QWidget):
    """Basis für Verwaltungs-Workspaces im Control Center."""
