"""
QAGovernanceScreen – Koordinator für QA-&-Governance-Workspaces.

Test- und Qualitätsübersicht, Coverage, Gap, Incidents, Replay.
Prüfen, Bewerten, Nachvollziehen.
"""
...
from app.gui.domains.qa_governance.qa_governance_nav import QAGovernanceNav
from app.gui.domains.qa_governance.workspaces import (
...
class QAGovernanceScreen(BaseScreen):
    """QA-&-Governance-Container: Nav + Workspace-Stack."""

    def __init__(self, parent=None):
        super().__init__(NavArea.QA_GOVERNANCE, parent)
    ...
    def _setup_ui(self):
        ...
        self._nav = QAGovernanceNav(self)
        layout.addWidget(self._nav)

        self._stack = QStackedWidget()
        self._stack.setObjectName("qaGovernanceWorkspaceHost")
        ...
        self._nav.set_current("qa_test_inventory")
    ...
    def show_workspace(self, workspace_id: str) -> None:
        """Zeigt einen Workspace (z.B. qa_coverage_map). Für Command Palette."""
