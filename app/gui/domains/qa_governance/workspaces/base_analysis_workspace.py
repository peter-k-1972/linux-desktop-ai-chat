"""
BaseAnalysisWorkspace – Basis für QA-&-Governance-Workspaces.

Test Inventory, Coverage Map, Gap Analysis, Incidents, Replay Lab.
...
class BaseAnalysisWorkspace(QWidget):
    """Basis für Analyse- und Governance-Workspaces."""
