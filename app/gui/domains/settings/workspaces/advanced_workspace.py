"""
AdvancedWorkspace – Debug Flags, Experimental Features, Developer Settings.
"""
...
class AdvancedWorkspace(BaseSettingsWorkspace):
    """Workspace für fortgeschrittene Optionen."""
    ...
    def _setup_ui(self):
        ...
        for title, text in [
            ("Debug-Flags", "Debug-Ausgaben, Log-Level."),
            ("Experimentelle Features", "Noch nicht stabile Funktionen."),
            ("Entwickler-Einstellungen", "Für Entwickler und Erweiterungen."),
        ]:
            panel = QFrame()
