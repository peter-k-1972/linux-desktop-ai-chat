...
def _build_registry() -> None:
    ...
    entries_list = [
        ...
        NavEntry(
            ...
            NavArea.OPERATIONS,
            "operations_workflows",
            "Gespeicherte DAGs: definieren, validieren, Test-Run, Historie",
            "workflows_workspace",
            "Workflow Editor",
            icon=SYSTEM_GRAPH,
        ),
        NavEntry(
            ...
            NavArea.OPERATIONS,
            "operations_deployment",
            "Artefakte, Ziele und Rollout-Historie (R4)",
        ...
        NavEntry(
            ...
            NavArea.OPERATIONS,
            "operations_audit_incidents",
            "Audit-Aktivität, Störungen aus fehlgeschlagenen Workflow-Läufen, Plattform-Checks (R1/R2)",
            "operations_betrieb",
            "Betrieb",
            icon=INCIDENTS,
        ),
        ...
        NavEntry("rd_markdown_demo", "Markdown Demo", NavArea.RUNTIME_DEBUG, "rd_markdown_demo",
                 "Markdown-Pipeline visuell prüfen (Hilfe/Chat/ASCII)", icon=SPARKLES),
    ...
    _SECTIONS = [
        NavSectionDef("project", "PROJECT",
                      ["command_center", "operations_projects"], True),
        NavSectionDef("workspace", "WORKSPACE",
                      ["operations_chat", "operations_knowledge", "operations_prompt_studio",
                       "operations_workflows", "operations_deployment", "operations_audit_incidents",
                       "operations_agent_tasks"], True),
        ...
        NavSectionDef("observability", "OBSERVABILITY",
                      ["runtime_debug", "rd_introspection", "rd_qa_cockpit", "rd_qa_observability", "rd_markdown_demo",
                       "rd_eventbus", "rd_logs", "rd_llm_calls", "rd_agent_activity", "rd_metrics", "rd_system_graph"],
                      False),
        NavSectionDef("quality", "QUALITY",
                      ["qa_governance", "qa_test_inventory", "qa_coverage_map", "qa_incidents", "qa_replay_lab",
                       "qa_gap_analysis"], False),
        NavSectionDef("settings", "SETTINGS",
                      ["settings", "settings_application", "settings_appearance", "settings_ai_models", "settings_data",
